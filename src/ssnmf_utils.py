...
'''
Haddock_Experiment = namedtuple('Haddock_Experiment', ['X_train', 'Y_train', 'X_test', 'Y_test', 'W_train', 'W_test'])
Needell_Experiment = namedtuple('Needell_Experiment', ['X', 'Y', 'L_train', 'train_indices', 'test_indices'])
...
Train_Results = namedtuple('Train_Results',['train_score', 'param_vals','xtrain_reconerr','ytrain_reconerr', 'experiment'])
