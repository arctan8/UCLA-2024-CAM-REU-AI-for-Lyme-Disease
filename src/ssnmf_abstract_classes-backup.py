...
class SSNMF_Application(ABC):
    ...
    def fulldatasearch(self,**kwargs):
        '''
        Conduct ssnmf on full dataset, without any splitting. Default
        ...
        self.fulldata_best_param_vals = best_param_vals_overall
        self.fulldata_best_model = self.get_best_fulldata_model()
        
        if get_topic_accu_distr and get_reconerr_distr:
            return best_accuracy_overall, best_param_vals_overall, accu_distr, Xreconerr_distr, Yreconerr_distr
        elif get_topic_accu_distr:
            return best_accuracy_overall, best_param_vals_overall, accu_distr
        elif reconerr_distr:
            return best_accuracy_overall, best_param_vals_overall, Xreconerr_distr, Yreconerr_distr
        else:
