...
class GenerateTrainTest:
    ...
    def getTrainTestIndices(self):
        ...
        sets into one while keeping track of the training set/testing set indices.
        In matrix X (resp. Y), the first 0 to self.train_samples indices are for training; the rest is for testing.
